...
class CICIoT23DataManager:
    ...
    """
    def __init__(self, data_root="C:/FederatedLearning/FL/core/data_split", data_folder="centralized_data"):
        self.data_root = data_root
        self.centralized_dir = os.path.join(data_root, data_folder)
    ...
    def select_exemplars(self, x, y, classes, m_per_class=20):
        ...
        for c in classes:
            ...
            indices = np.random.choice(n_samples, min(m_per_class, n_samples), replace=False)
